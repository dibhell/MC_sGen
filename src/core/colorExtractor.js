...
export class ColorExtractor {
  ...
  static analyzeImage(img) {
    ...
    // 1. Strefa Twarzy i Odcienia Skóry
    const faceColor = getAverageColor(0.40, 0.12, 0.60, 0.22);
    
    // 2. Strefa Czubka Głowy / Włosów
    ...
    const hasGlasses = eyeZoneColor.r < 95 && eyeZoneColor.g < 95 && eyeZoneColor.b < 95;
